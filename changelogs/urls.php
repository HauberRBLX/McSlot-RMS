<meta name='og:title' content='URLShortener • McSlot'>
<meta name="description" content="Changelog / System | URLShortener">
<meta name="keywords" content="URLShortener, ELSystem">
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-10 col-lg-12">
          ...
          $sql = "SELECT * FROM urlshort_changelogs ORDER BY Version DESC";
