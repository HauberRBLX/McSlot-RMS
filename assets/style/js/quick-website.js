...
var Popover = function() {
  ...
  , DarkMode = function() {
    ...
    function e(t, e) {
        if (t) {
            var a, o = s.getAttribute("href").split("/"), n = o[o.length - 1];
            ...
            "dark" == t ? (i.classList.add("text-warning"),
            i.setAttribute("data-mode", "light")) : (i.classList.remove("text-warning"),
            i.setAttribute("data-mode", "dark")),
            document.getElementById("header-main") && function(t) {
                var e, a = document.getElementById("header-main"), o = document.getElementById("navbar-main"), n = document.getElementById("navbar-logo"), i = n.getAttribute("src").split("/"), s = i[i.length - 1];
                a.classList.contains("header-transparent") || (e = "dark" == t ? (o.classList.remove("navbar-light", "bg-white"),
                o.classList.add("navbar-dark", "bg-dark"),
                n.getAttribute("src").replace(s, "light.svg")) : (o.classList.remove("navbar-dark", "bg-dark"),
  ...
  , Dropdown = function() {
    ...
    e.length && e.on("click", function() {
        return function(t) {
            ...
            t.parents(".nav-item.dropdown.show").on("hidden.bs.dropdown", function() {
    ...
    $(".dropdown-menu").on("click", function(t) {
        ...
        for (var a = 0; a < e.length; a++)
            e[a].selector && ($(t.target).is(e[a].selector) && e[a].handler.call(t.target, t),
            $(t.target).parents(e[a].selector).each(function() {
    ...
    t.length && t.each(function() {
        ...
        e.on("change", function(t) {
            !function(t, e, a) {
                ...
                e && 1 < e.files.length ? o = (e.getAttribute("data-multiple-caption") || "").replace("{count}", e.files.length) : a.target.value && (o = a.target.value.split("\\").pop()),
            ...
            setInterval(function() {
                ...
                function(t) {
                    var e = $(window).scrollTop()
                      , a = t.outerHeight();
                    o + 200 < e ? (t.addClass("sticky"),
                    $("body").css("padding-top", a + "px")) : (t.removeClass("sticky"),
    ...
    t.length && e.on({
        click: function() {
            !function(t) {
                ...
                t.hasClass("active") || ($("." + e.attr("class") + " button[data-pricing]").removeClass("active"),
                t.addClass("active"),
                a.each(function() {
  ...
  , ScrollTo = function() {
    ...
    t.length && t.on("click", function() {
        !function(t) {
            ...
            $("html, body").stop(!0, !0).animate(o, 300),
  ...
  , GoogleMapCustom = function() {
    ...
    void 0 !== t && null != t && google.maps.event.addDomListener(window, "load", function(t) {
        ...
        l = t.getAttribute("data-zoom") ? parseInt(t.getAttribute("data-zoom")) : 12;
  ...
  , GoogleMap = function() {
    ...
    void 0 !== t && null != t && google.maps.event.addDomListener(window, "load", function(t) {
        i = t.getAttribute("data-lat"),
        s = t.getAttribute("data-lng"),
        r = t.getAttribute("data-zoom") ? parseInt(t.getAttribute("data-zoom")) : 12;
        var e = new google.maps.LatLng(i,s)
          , a = {
            zoom: r,
            scrollwheel: !1,
...
var Counter = function() {
  ...
  , Highlight = void $(".highlight").each(function(t, e) {
    !function(t, e) {
        $(e).before('<button class="action-item btn-clipboard" title="Copy to clipboard"><i data-feather="copy"></i></button>'),
        ...
        !function(t) {
            ...
            o.on("click", "a", function(t) {
                ...
                i.isotope({
                    ...
                    o.find("[data-filter]").removeClass("active"),
                    e.addClass("active")
                })
            })
        }($(this))
  ...
  , ProgressCircle = function() {
    ...
    t.length && t.each(function() {
        !function(t) {
            ...
            if ("circle" == s)
                var l = new ProgressBar.Circle(t[0],r);
            else if ("semi-circle" == s)
                l = new ProgressBar.SemiCircle(t[0],r);
            l.animate(e / 100)
        }($(this))
    })
}()
  ...
  , ApexOrdersChart = function() {
    var a, t, e, o = document.querySelector("#apex-orders"), n = ($(".legend input"),
    [PurposeStyle.colors.theme.primary, PurposeStyle.colors.theme.warning]);
    if (o)
        return t = {
            chart: {
                type: "bar",
        ...
        e = o.dataset.height,
        t.colors = n,
        t.chart.height = e || 350,
        a = new ApexCharts(o,t),
        setTimeout(function() {
            a.render(),
            function() {
                for (var t = document.querySelectorAll(".legend input[type='checkbox']"), e = 0; e < t.length; e++)
                    t[e].checked || a.toggleSeries(t[e].value)
            }()
        }, 300),
        {
  ...
  , ApexTasksChart = function() {
    var t, e, a, o = document.querySelector("#apex-tasks"), n = ($(".legend input"),
    [PurposeStyle.colors.theme.primary, PurposeStyle.colors.theme.warning]);
    o && (e = {
        chart: {
            type: "bar",
    ...
    a = o.dataset.height,
    e.colors = n,
    e.chart.height = a || 350,
    t = new ApexCharts(o,e),
    setTimeout(function() {
        t.render()
    }, 300))
}();
