...
$errorScript = "<script>setInterval(function (){window.location.reload()}, 5000)</script>";
if (isset($services[""]) && $services[""] == null || $services == null || !count($services) > 0) {
...
// echo "<script>console.log('" . json_encode($items) . "')</script>";
    ...
    <head>
        ...
        <link rel="stylesheet" href="https://status.ysenayit.de/assets/css/style.css">
        <noscript data-n-css=""></noscript>
        <script src="https://status.ysenayit.de/assets/js/style.js"></script>
        <style id="_goober">
    ...
    <script>
        ...
        setInterval(function (x) {
            ...
            document.getElementById('progressint').innerText = Number(i/1000).toFixed(1)
            if (i == 60000) {
                window.location.reload();
            }
            ...
            <div class="section footer">
                <div class="flex justify-content-space-between align-items-center width-100 sm-footer"
                    ...
                    <div><a class="powered-by text-color text-decoration-none clickable" target="_blank"
                            ...
                            href="https://mcslot.de">Powered
                            by <span class="color-text-blue">McSlot.DE</span></a></div>
                </div>
            </div>
        </div>
    </div>
